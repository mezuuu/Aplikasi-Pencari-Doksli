...
ONLINE_FALLBACK_MIN_SCORE = 0.0
WEB_RERANK_WITH_EMBEDDING = os.getenv('WEB_RERANK_WITH_EMBEDDING', 'false').lower() in ('true', '1', 'yes')
...
ENABLE_CROP_FALLBACK = os.getenv('ENABLE_CROP_FALLBACK', 'false').lower() in ('true', '1', 'yes')
